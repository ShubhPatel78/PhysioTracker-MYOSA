 ...
 * ║          MYOSA ESP32-WROVER + MPU-6050 Physiotherapy Hub (Zero Dependencies)║
 * ╚════════════════════════════════════════════════════════════════════════════╝
 *
 * Requirements:
 *   - ESP32 Board Package installed in Arduino IDE
 *   - No external third-party library installations required!
 *
...
// ─── Build Telemetry JSON (Pure string formatting - zero library deps) ─────
...
void setup() {
  ...
  Serial.println("║  Zero External Dependencies – Standard ESP32 Core ║");
  Serial.println("╚═══════════════════════════════════════════════════╝");
...
print("Created pure BLE zero-dependency firmware!")
